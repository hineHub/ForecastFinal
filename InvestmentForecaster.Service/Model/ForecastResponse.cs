...
namespace InvestmentForecaster.Service.DTO
{
    ...
    {
        public ForecastResponse(int index, decimal totalInvestmentAmount, decimal totalValueWideLower, decimal totalValueNarrowLower, decimal totalValueWideUpper, decimal totalValueNarrowUpper)
        {
            Index = index;
        ...
        public ForecastResponse(decimal lumpSum)
        {
